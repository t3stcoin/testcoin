...
uint256 hashGenesisBlock("0xdddda0a67e3b10a8070f3249c0b15c7ce0d6e8f3a4fbd77fa8d4cf8c5ff76f12");
...
static const int64 nTargetTimespan = 10 * 30; // Testcoin: 5 minutes
static const int64 nTargetSpacing = 1 * 30; // Testcoin: 30 seconds
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xdddda0a67e3b10a8070f3249c0b15c7ce0d6e8f3a4fbd77fa8d4cf8c5ff76f12");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "This is Testcoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xc3058e15aca1103c831b353943526c4d419dce606c0b9b24fdaedd6a78c67a93"));
